...
global value setting it also does two things that are easy to miss:
...
again. World settings have no such gate: they behave the same whether `Enabled` is true or false.
