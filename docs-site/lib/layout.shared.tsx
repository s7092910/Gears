...
// Kept last in every `links` list, so it sits beside the GitHub icon that `githubUrl` appends.
...
// The Discord logo from Simple Icons, drawn the same way as Fumadocs' GitHub icon.
